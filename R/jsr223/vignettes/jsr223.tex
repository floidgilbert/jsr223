...
This example shows how so-called ``glue'' code can be embedded in R to quickly leverage sophisticated Java solutions. It also demonstrates how easily \pkg{jsr223} converts Java data structures to R objects.
