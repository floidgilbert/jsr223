...
class DataFrameEditor extends Application {
  ...
  public ArrayBlockingQueue<Object[]> queue = new ArrayBlockingQueue<Object[]>(1);
...
/*      if (o.length == 0)
        break;*/
      //stage.setTitle(o[0]);
      stage.setTitle(queue.size().toString());
///      browser.init(o[1], [2])
...
dfe = new DataFrameEditor();
dfe.queue.put(new Object[0]);
println(dfe.queue.size());
