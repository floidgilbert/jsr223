...
Kotlin is a programming language JetBrains/// designed for the JVM, interopable with Java, but more /// than Java. It can be compiled to bytecode or JavaScript source code. Less code. \href{https://www.javascripting.com/}{JavaScripting}. What is the draw of Kotlin? It's a modern programming language, similar to Scala///ref.


///note the problem, like Ruby, where when an error occurs, it can't recover.
///use embedded double quotes for strings.

%///Do note that leads into bindings section below..

\subsection{Kotlin bindings}

%///what's different and provide some sample code.
