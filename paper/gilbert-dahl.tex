...
\pkg{jsr223} features string interpolation before code execution. R code placed between \code{@\{} and \code{\}} in a script is evaluated and replaced by the a string representation of the return value. A script may contain multiple \code{@\{...\}} expressions.
...
%///I have a better example elsewhere
\begin{verbatim}
a <- 1; b <- 2
engine %~% "@{a} + @{b}"
